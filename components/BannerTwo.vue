      ...
      <no-ssr>
        <carousel :items="1">
          ...
          <div class="slide-item">
            <div
              class="image-layer"
              style="background-image: url(/images/main-slider/impresora.png)"
            ></div>
            ...
            <div class="auto-container">
              <div class="content-box">
                <div class="content">
                  <div class="inner">
                    <div class="sub-title">Bienvenido a InnovaConsulting</div>
                    <h1>Servicios de Impresoras</h1>
                    <div class="link-box">
                      <nuxt-link class="theme-btn btn-style-one" to="/about">
                        <i class="btn-curve"></i>
                        <span class="btn-title">+ Informacion</span>
                      </nuxt-link>
                    </div>
                  </div>
                </div>
          ...
          <div class="slide-item">
            <div
              class="image-layer"
              style="background-image: url(/images/main-slider/contaduria.jpg)"
            ></div>
            <div class="shape-1"></div>
            <div class="shape-2"></div>
            <div class="shape-3"></div>
